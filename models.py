...
class DAOWrapper:
    def __init__(self):
        self.db = TinyDB(storage=tinydb.storages.MemoryStorage)
    ...
    def load_from_json(self, json_path: str):
        with open(json_path, 'r') as f:
            ...
            self.courses.insert_multiple([Course(c['code'], c['name']).to_doc() for c in courses])
