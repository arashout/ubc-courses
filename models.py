...
class DAOWrapper:
    ...
    def insert_courses(self, courses: typing.List[CourseAbstract]):
        try:
            self.generic_course.objects.insert(
                courses, write_concern={"continue_on_error": True}
            )
        except me.NotUniqueError:
            pass

    def insert_course(self, course: CourseAbstract) -> typing.Optional[CourseAbstract]:
        try:
            return course.save()
        except me.NotUniqueError:
            return None
